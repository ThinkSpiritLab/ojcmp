...
use crate::byte_reader::{Byte, ByteReaderLike};
use crate::compare::Comparison;

pub struct NormalComparer {
    _priv: (),
}
...
impl ByteComparer for NormalComparer {
...
fn poll_eof(bytes: &mut impl ByteReaderLike) -> bool {
...
fn poll_endline(bytes: &mut impl ByteReaderLike) -> bool {
    let mut b = bytes.next_byte();
    loop {
...
/// poll until b'\n' or non-space or EOF
fn poll_nonspace(bytes: &mut impl ByteReaderLike) -> Byte {
    let mut b: Byte = bytes.next_byte();
    loop {
